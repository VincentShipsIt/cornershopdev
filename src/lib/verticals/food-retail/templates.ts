...
> = {
  "daily-counter": {
    ...
    copy: {
      en: {
        catalogEyebrow: "From the counter",
        catalogHeading: "Made for today.",
        featuredHeading: "Today’s selection",
        featuredSubheading: "See what is on the counter.",
      },
      fr: {
        catalogEyebrow: "Au comptoir",
        catalogHeading: "Préparé pour aujourd’hui.",
        featuredHeading: "La sélection du jour",
        featuredSubheading: "Découvrez ce qui vous attend au comptoir.",
      },
    },
  },
  "craft-counter": {
    ...
    copy: {
      en: {
        ...
        catalogHeading: "Chosen, prepared, ready.",
        featuredHeading: "At the counter",
        featuredSubheading: "Products presented as they are sold.",
      },
      fr: {
        catalogEyebrow: "La gamme",
        catalogHeading: "Choisi, préparé, prêt.",
        featuredHeading: "Au comptoir",
        featuredSubheading: "Les produits tels qu’ils sont proposés.",
      },
    },
  },
  "market-shelves": {
    ...
    copy: {
      en: {
        ...
        catalogHeading: "What the shop carries.",
        featuredHeading: "From the shelves",
        featuredSubheading: "A closer look at the current range.",
      },
      fr: {
        catalogEyebrow: "Gammes de produits",
        catalogHeading: "Ce que propose la boutique.",
        featuredHeading: "Dans les rayons",
        featuredSubheading: "Un aperçu de la gamme actuelle.",
      },
    },
  },
};
